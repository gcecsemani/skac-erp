...
def _match_report_key(q: str) -> str | None:
    aliases = [
        ...
        ("vendor_stock", ("vendor stock", "vendor-wise stock", "stock by vendor")),
        ...
        ("customer_outstanding", ("customer outstanding", "farmer outstanding", "khata outstanding", "khata balance")),
        ("khata_by_village", ("khata by village", "village khata", "khata village")),
